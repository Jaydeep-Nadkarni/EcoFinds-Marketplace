    ...
    <footer className="bg-gray-900 text-gray-300 mt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 lg:col-span-2">
            <div className="flex items-center mb-4">
              ...
              <span className="text-xl font-bold text-white">StyleMart</span>
            </div>
            <p className="text-gray-400 mb-4 max-w-md">
              Discover the latest trends in fashion, electronics, home goods and more. Quality products at affordable prices with fast shipping.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors duration-200">Discounts</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors duration-200">Weekly Deals</a></li>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex w-full md:w-auto">
              <input 
                ...
                className="px-4 py-2 rounded-l-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 w-full md:w-64 text-gray-900"
              />
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-gray-400">© {new Date().getFullYear()} StyleMart. All rights reserved.</p>
          <div className="flex space-x-4 mt-4 md:mt-0">
            ...
            <a href="#" className="text-sm text-gray-400 hover:text-white transition-colors duration-200">Sitemap</a>
          </div>
        </div>
      </div>
    </footer>
